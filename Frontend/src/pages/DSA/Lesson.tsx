...
return (
  <div className="min-h-screen bg-slate-950 text-white">
    <div className="max-w-5xl mx-auto p-10">
      ...
      {/* Show only after Lesson 10 */}
      {lesson.id === 10 && (
        <div className="mt-12 flex justify-center">
          <button
            onClick={() => navigate("/quiz")}
            className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-bold text-lg shadow-lg hover:scale-105 transition duration-300"
          >
            🚀 Now Let's Test You!
          </button>
        </div>
