      ...
      <main className="mx-auto max-w-5xl px-6 py-10 w-full">
        ...
        <div className="leetcode-panel rounded-xl p-8 mb-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-purple-200 bg-purple-50 px-3 py-1 text-xs font-bold text-purple-700 mb-3">
            <BookOpen size={13} />
            <span>Lesson {lesson.id} of {stackLesson.length} • Stack Modules</span>
          </div>
        ...
        <div className="mt-8 flex items-center justify-between pt-6 border-t border-slate-200">
          ...
          {lesson.id < 10 ? (
            <button
              onClick={() => navigate(`/learn-stack/${lesson.id + 1}`)}
            ...
            <button
              ...
              className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-bold text-xs shadow-xs border border-purple-500 flex items-center gap-2 transition"
            >
              <Sparkles size={16} className="fill-white stroke-[2.5]" />
