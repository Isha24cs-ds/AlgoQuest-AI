...
export default function StackTrack() {
  ...
  const cards = [
    {
      title: "Learn Stacks",
      subtitle: "LIFO principles, operations & call stack mechanics",
      icon: BookOpen,
      route: "/learn-stack",
    ...
    },
    {
      ...
      subtitle: "Solve 30 curated stack coding challenges",
      icon: PlayCircle,
    ...
    },
    {
      ...
      subtitle: "Test push, pop, min-stack & bracket matching rules",
      icon: Brain,
      route: "/quiz",
    ...
    },
    {
      ...
      subtitle: "Monotonic stack & next greater element problems",
      icon: Swords,
      route: "/miniboss",
    ...
    },
    {
      ...
      subtitle: "Histogram max area & expression parsing problem set",
      icon: Crown,
      route: "/finalboss",
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 flex flex-col justify-between">
      ...
      <main className="mx-auto max-w-7xl px-6 py-10 w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-purple-200 bg-purple-50 px-3 py-1 text-xs font-bold text-purple-700 mb-3">
                <Sparkles size={13} />
                <span>Track 05 • Data Structures</span>
              </div>
              <h1 className="font-heading text-3xl font-extrabold text-slate-900 sm:text-4xl">
                Stacks Track
              </h1>
              <p className="text-slate-600 text-sm mt-1 font-medium">
                Master Last-In First-Out (LIFO) operations, monotonic stacks, bracket validation, and min-stack designs.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="leetcode-card px-4 py-2.5 rounded-lg flex items-center gap-2">
                ...
                <div className="text-left">
                  <span className="block text-xs font-bold text-slate-900">350 XP</span>
        ...
        {/* AI Mentor Callout */}
        <div className="rounded-xl border border-purple-300 bg-purple-50/80 p-6 mb-8 shadow-xs flex items-start gap-4">
          <div className="h-10 w-10 rounded-lg bg-purple-600 text-white font-bold flex items-center justify-center shrink-0">
            <Sparkles size={20} />
          </div>
          <div>
            ...
            <p className="text-xs leading-relaxed text-slate-700 mt-1 font-medium">
              Welcome to Stacks! Monotonic stacks are extremely powerful for linear-time problem solving. Ask Nova for real-time hints anytime!
            </p>
          </div>
        </div>
          ...
          {cards.map((card) => {
            ...
            return (
              <button
                ...
                className="leetcode-card rounded-xl p-6 text-left border border-slate-200 bg-white hover:border-purple-500/50 transition-all flex flex-col justify-between h-48 group"
              >
                <div>
                  ...
                  <h3 className="font-heading text-lg font-bold mt-4 text-slate-900 group-hover:text-purple-600 transition-colors">
                    {card.title}
                  </h3>
