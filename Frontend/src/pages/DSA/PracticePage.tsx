...
import { practiceQuestions, type QuestionItem } from "../../data/practiceQuestions";
...
export default function PracticePage() {
  ...
  const countEasy = practiceQuestions.filter((q) => q.difficulty === "Easy").length;
  const countMedium = practiceQuestions.filter((q) => q.difficulty === "Medium").length;
  const countHard = practiceQuestions.filter((q) => q.difficulty === "Hard").length;
      ...
      <main className="mx-auto max-w-7xl px-6 py-10 w-full flex-1">
        ...
        <div className="leetcode-panel rounded-xl p-8 mb-8">
          ...
          <p className="text-slate-600 text-sm mt-1 font-medium max-w-2xl">
            Solve 30 curated Array interview problems covering Two Pointers, Sliding Window, Kadane's Algorithm, Prefix Sums, and Monotonic Stacks.
          </p>
        </div>
